...
First, thank you for considering contributing to Metis. We appreciate the time and effort you are willing to invest. This document outlines the guidelines for contributing to the project to ensure a smooth and effective process for everyone involved.
...
2.  **Clone Your Fork**: Clone your forked repository to your local machine.
    ...
    cd metis
    ```
3.  **Create a Branch**: Create a new branch for your changes. Use a descriptive name (e.g., `fix/memory-leak` or `feature/new-eviction-policy`).
    ```bash
...
Thank you for helping make Metis a better library!
